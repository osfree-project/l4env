...
#define EVENT union event_union
...
//	long	state;			/* button state (bit0-left bit1-middle bit2-right) */
};
...
union event_union {
	...
	struct release_event	release;
	struct action_event		action;
};
