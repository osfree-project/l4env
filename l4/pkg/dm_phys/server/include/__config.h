 ...
 */
#define DMPHYS_MEMMAP_START           0x40000000

/**
 * memory map area size 
 */
#define DMPHYS_MEMMAP_SIZE            0x40000000
#define DMPHYS_MEMMAP_LOG2_SIZE       30

/**
 * map address for kernel info page
 */
#define DMPHYS_KINFO_MAP              0x00001000
