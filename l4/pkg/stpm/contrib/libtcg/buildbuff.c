...
/*                                                                          */
/*  Add %I and compile fixes by Bernhard Kauer <kauer@tudos.org> */
/*                                                                          */
/****************************************************************************/
...
/*                                                                          */
/*  I                                                                       */
/*     This is used to ignore a parameter.                                  */
/*                                                                          */
/*  Example                                                                 */
/*                                                                          */
...
int buildbuff(char *format, unsigned char *buffer, ...)
{
    ...
    if (totpos != 0)
        *(unsigned long *) (totpos + 0) = htonl(totlen);
    va_end(argp);
    return totlen;
}
