// taken from Linux 2.4.31 and adapted for use in the ORe package 
// Bjoern Doebel <doebel@os.inf.tu-dresden.de>  08/22/2005
...
"eepro100.c: $Revision: 1.2 $ 2000/11/17 Modified by Andrey V. Savochkin <saw@saw.sw.com.sg> and others\n";
