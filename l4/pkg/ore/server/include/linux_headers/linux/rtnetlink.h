/* linux/rtnetlink.h - taken from Linux 2.4.31 and modified for use in the ORe package 
 */
...
#ifdef __ORE__
extern l4semaphore_t rtnl_sem_ore;
#endif
...
#else
#define ASSERT_RTNL() do { if (l4semaphore_try_down(&rtnl_sem_ore) == 1)    \
            {                                                                   \
