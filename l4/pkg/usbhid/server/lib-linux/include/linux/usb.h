...
#define KRISHNA_INFO(fmt, args...) printk("usb: " fmt "\n", ##args)
#ifdef DEBUG
#define dbg(args...) KRISHNA_INFO(args)
#else
#define dbg(args...) do {} while (0)
#endif
#define err(args...) KRISHNA_INFO(args)
#define info(args...) KRISHNA_INFO(args)
#define warn(args...) KRISHNA_INFO(args)
