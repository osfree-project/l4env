...
#if defined(CFG_3C90X_BOOTROM_FIX) || defined(CFG_3C90X_XCVR)
...
a3c90x_disable(struct nic *nic)
	...
	/* Disable the receiver and transmitter. */
        a3c90x_internal_SetWindow(INF_3C90X.IOAddr, winPowerVlan7);
...
//    printf("3C90X Driver 2.00\n");
    ...
    printf("MAC Address = %02x:%02x:%02x:%02x:%02x:%02x\n",
        INF_3C90X.HWAddr[0] & 0xff,
	INF_3C90X.HWAddr[1] & 0xff,
	INF_3C90X.HWAddr[2] & 0xff,
	INF_3C90X.HWAddr[3] & 0xff,
	INF_3C90X.HWAddr[4] & 0xff,
	INF_3C90X.HWAddr[5] & 0xff);
