...
drops {
    ...
    HEADERS += $$EMBEDDED_H/qgfxdrops_qws.h \
	       $$EMBEDDED_H/qmousedrops_qws.h \
	       $$EMBEDDED_H/qkbddrops_qws.h
    SOURCES += $$EMBEDDED_CPP/qgfxdrops_qws.cpp \
	       $$EMBEDDED_CPP/qmousedrops_qws.cpp \
	       $$EMBEDDED_CPP/qkbddrops_qws.cpp
}
