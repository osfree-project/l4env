...
void QStyleSheet::init()
{
    ...
    // The name of this QStyleSheetItem originally was "", but this
    // caused a warning from QGDict<...> when it would be inserted
    // into the dictionary. Also, Qt crashed in QRichText stuff,
    // because the item could not be referenced using name "" (this
    // led to a null pointer derefernce). I changed the name for now,
    // let's hope this doesn't break the public API ...
    nullstyle  = new QStyleSheetItem( this,
	QString::fromLatin1("__null_item_0x34a0b53a__") );
#else
    nullstyle  = new QStyleSheetItem( this,
	QString::fromLatin1("") );
#endif
