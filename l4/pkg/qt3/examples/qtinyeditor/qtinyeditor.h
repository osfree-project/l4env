...
#ifndef QTINYEDITOR_H
#define QTINYEDITOR_H
...
/**
  ...
  * and statusbar. For the main view, an instance of class QTinyEditorView is
  * created which creates your view.
  * 	
  * @author Source Framework Automatically Generated by KDevelop, (c) The KDevelop Team.
  * @version KDevelop version 1.3 code generation
  */
class QTinyEditorApp : public QMainWindow
{
  Q_OBJECT
  ...
  protected:
    ...
    bool queryExit(QString strFileNotSaved);
     ...
     * @see QTinyEditorDoc#addView
     * @see QTinyEditorDoc#openDocument
     * @param doc pointer to the document instance that the view will
     * be connected to.
     */
    void createClient(QTinyEditorDoc* doc);
