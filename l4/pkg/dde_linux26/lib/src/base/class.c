...
/*****************************************************************************/
/**
 * \file   dde_linux26/lib/src/base/class.c
 * \brief  basic device class management
 *
 * \author Marek Menzer <mm19@os.inf.tu-dresden.de>
 *
 * Original by Patrick Mochel, Open Source Development Labs,
 *             Greg Kroah-Hartman and IBM Corp.
 *
 */
