/**
 * \file	loader/include/l4/loader/grub_mb_info.h
 *
 * \brief	Multiboot info structure as taken from GRUB */
...
struct grub_multiboot_info
{
  ...
  /** VESA segment of protected mode BIOS interface */
  unsigned short vbe_interface_seg;

  /** VESA offset of protected mode BIOS interface */
  unsigned short vbe_interface_off;

  /** VESA lenght of protected mode BIOS interface */
