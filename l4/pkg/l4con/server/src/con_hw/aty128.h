...
/* most stuff taken from Linux 2.2.25: drivers/video/aty128.h and from
 * mplayer/vidix/drivers/radeon.h */
...
{
  *((volatile unsigned char *)(ati128_regbase + regindex)) = val;
}

static inline void 
aty_st_le32(int regindex, unsigned val)
{
  *((volatile unsigned *)(ati128_regbase + regindex)) = val;
}

static inline unsigned
aty_ld_le32(int regindex)
{
  return *((volatile unsigned *)(ati128_regbase + regindex));
}

static inline l4_uint32_t
aty_in_pll(l4_uint32_t addr)
{
  aty_st_8(CLOCK_CNTL_INDEX, addr & 0x0000001f);
  return (aty_ld_le32(CLOCK_CNTL_DATA));
}

extern void aty128_wait_for_fifo(unsigned short entries);
extern void aty128_wait_for_idle(void);
