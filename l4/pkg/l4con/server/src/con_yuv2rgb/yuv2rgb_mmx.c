...
static inline void mmx_yuv2rgb (const uint8_t * py, const uint8_t * pu, 
				const uint8_t * pv)
{
...
static inline void mmx_unpack_16rgb_2 (uint8_t * image, int cpu)
{
    static mmx_t mmx_bluemask = {0xf8f8f8f8f8f8f8f8LL};
    static mmx_t mmx_greenmask = {0xfcfcfcfcfcfcfcfcLL};
    static mmx_t mmx_redmask = {0xf8f8f8f8f8f8f8f8LL};
    ...
    por_r2r (mm2, mm0);
    movq_r2r (mm0, mm3);
    punpcklwd_r2r (mm0, mm3);
    movntq (mm3, *image);
    punpckhwd_r2r (mm0, mm0);
    movntq (mm0, *(image+8));
    ...
    por_r2r (mm7, mm5);
    movq_r2r (mm5, mm3);
    punpcklwd_r2r (mm5, mm3);
    movntq (mm3, *(image+16));
    punpckhwd_r2r (mm5, mm5);
    movntq (mm5, *(image+24));
}
...
static inline void yuv420_rgb16 (uint8_t * image, const uint8_t * py, 
...
static inline void yuv420_rgb16_2 (uint8_t * image, const uint8_t * py,
				 const uint8_t * pu, const uint8_t * pv,
				 int width, int height,
				 int rgb_stride, int y_stride, int uv_stride,
				 int cpu)
...
static inline void yuv420_argb32 (uint8_t * image, const uint8_t * py,
				  const uint8_t * pu, const uint8_t * pv,
				  int width, int height,
				  int rgb_stride, int y_stride, int uv_stride,
				  int cpu)
...
static void mmxext_rgb16 (uint8_t * image, const uint8_t * py, 
			  const uint8_t * pu, const uint8_t * pv,
			  int width, int height,
			  int rgb_stride, int y_stride, int uv_stride)
{
  if (width < height)
    /* scale x dimension by 2 */
    yuv420_rgb16_2 (image, py, pu, pv, width, height,
...
static void mmxext_argb32 (uint8_t * image, const uint8_t * py, 
			   const uint8_t * pu, const uint8_t * pv,
			   int width, int height,
			   int rgb_stride, int y_stride, int uv_stride)
{
...
static void mmx_rgb16 (uint8_t * image, const uint8_t * py, 
		       const uint8_t * pu, const uint8_t * pv,
		       int width, int height,
		       int rgb_stride, int y_stride, int uv_stride)
{
...
static void mmx_argb32 (uint8_t * image, const uint8_t * py, 
			const uint8_t * pu, const uint8_t * pv,
			int width, int height,
			int rgb_stride, int y_stride, int uv_stride)
{
