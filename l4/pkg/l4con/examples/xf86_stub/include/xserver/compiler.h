...
/* For ARM Linux, we use the LIBC inx/outx defined in sys/io.h (below) */

#if !defined(__sparc__) && (!defined(__arm__) || !defined(linux))
...
#elif defined(__sparc__) /* __sparc__ */
...
#if !defined(FAKEIT) && !defined(__mc68000__) && !defined(__arm__) && !defined(__hppa__)
#ifdef GCCUSESGAS
...
#else /* !defined(FAKEIT) && !defined(__mc68000__) && !defined(__arm__) */
