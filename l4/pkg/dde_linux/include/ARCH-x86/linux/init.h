...
#define __initdata
#define __exitdata	__attribute__ ((unused))
#define __initsetup	__attribute__ ((unused))
#define __init_call	#error __init_call used directly?
#define __exit_call	#error __exit_call used directly?
#endif /* DDE_LINUX */
