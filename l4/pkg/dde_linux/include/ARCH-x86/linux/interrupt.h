...
asmlinkage void do_softirq(void);
//extern void open_softirq(int nr, void (*action)(struct softirq_action*), void *data);
/* removed softirq_init() because of name clash */

extern void __cpu_raise_softirq(unsigned cpu, int nr);
...
/* removed tasklet_vec[] and tasklet_hi_vec[]; they are internal and in
   softirq.c now */
#ifndef DDE_LINUX
...
#else /* DDE_LINUX */
/* removed __tasklet_schedule; not needed and should not be called directly */
/* tasklet_schedule() is in softirq.c now */
extern void tasklet_schedule(struct tasklet_struct *t);

/* removed __tasklet_hi_schedule; not needed and should not be called
   directly */
/* tasklet_hi_schedule() is in softirq.c now */
