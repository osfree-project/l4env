...
asm(
	...
	"   mov r0, r2\n" /* L4: env page pointer comes via r2 and goes as 1st arg */
	"	bl	_dl_start\n"
...
#define START() do {														\
		register l4_umword_t r0 asm("r0") = ~(L4UTIL_MB_VALID);				\
		register l4_umword_t r1 asm("r1") = env->addr_mb_info;				\
		register l4_umword_t r2 asm("r2") = (l4_umword_t)env;				\
		register l4_umword_t r3 asm("r3") = (l4_umword_t)_dl_elf_main;		\
