...
// fm3: extern unsigned char *_dl_malloc_addr; /* Lets _dl_malloc use the already allocated memory page */
// fm3: extern unsigned char *_dl_mmap_zero;   /* Also used by _dl_malloc */
