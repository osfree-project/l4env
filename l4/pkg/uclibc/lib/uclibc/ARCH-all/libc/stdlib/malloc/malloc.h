...
/* FM3: sbrk not implemented */
#undef MALLOC_USE_SBRK
/* make sure that we munmap areas with the same size we mmapped */
#define __UCLIBC_UCLINUX_BROKEN_MUNMAP__
