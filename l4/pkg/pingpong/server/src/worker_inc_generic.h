/* $Id: worker_inc_generic.h 28892 2007-06-08 13:54:07Z adam $ */
/*****************************************************************************/
/**
  ...
  while (1)
    {
      ...
      l4_ipc_call(ping_id, L4_IPC_SHORT_MSG, 0, 0,
                  (void *)1, &dw0, &dw1, L4_IPC_NEVER, &dope);
#if 0
      asm volatile
	(
	 "push %%ebp              \n\t"
      ...
      while (1)
	{
	  ...
	  l4_ipc_reply_and_wait(ping_id, L4_IPC_SHORT_FPAGE, dw0, dw1,
	                        &ping_id, (void *)1, &dw0, &dw1, L4_IPC_NEVER, &dope);
#if 0
	  asm volatile
	    (
	     "push %%ebp        \n\t"
...
PREFIX(ping_pagefault_thread)(void)
{
  ...
  for (i = rounds; i; i--)
    {
      dummy = *(volatile unsigned long *)dw0;
      dummy = *(volatile unsigned long *)(dw0 + fpagesize);
      dw0 += 2 * fpagesize;
