...
static  grid3d *g = NULL;
static  surf3d *s = NULL;
...
void
surf3d_draw (surf3d * s, int color, int dist, int *buf, int *back, int W,
	     int H)
{
  int i;
  int *p1;
...
void
grid3d_draw (grid3d * g, int color, int colorlow,
