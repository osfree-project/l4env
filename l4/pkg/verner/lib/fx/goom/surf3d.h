...
void grid3d_free(void);

void grid3d_update (grid3d * s, float angle, float *vals, float dist);

/* low level */
void surf3d_draw (surf3d * s, int color, int dist, int *buf, int *back, int W,
		  int H);
void grid3d_draw (grid3d * g, int color, int colorlow, int dist, int *buf,
		  int *back, int W, int H);
