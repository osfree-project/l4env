...
uint64_t __attribute__((aligned(8))) b01= 		0x0101010101010101LL;
uint64_t __attribute__((aligned(8))) b02= 		0x0202020202020202LL;
uint64_t __attribute__((aligned(8))) b08= 		0x0808080808080808LL;
uint64_t __attribute__((aligned(8))) b80= 		0x8080808080808080LL;
#endif
...
//			printf("Compareing %s, %s, %s\n", filters[i].shortName,filters[i].longName, filterName);
	...
	if(ppMode->error)
	{
		printf("postprocess.c: %d errors in postprocess string \"%s\"\n", ppMode->error, name);
		free(ppMode);
		return NULL;
	}
	return ppMode;
