   ...
   for (gr=0; gr<2; gr++) 
   {
     for (ch=0; ch<stereo; ch++) 
     {
       ...
       if(gr_info->big_values > 288) {
          printf("mpglib: big_values too large!\n");
...
/* window-switching flag == 1 for block_Type != 0 .. and block-type == 0 -> win-sw-flag = 0 */
       if(get1bit()) 
       {
         ...
         if(gr_info->block_type == 0) {
           printf("mpglib: Blocktype == 0 and window-switching == 1 not allowed.\n");
           return 0;
         }
 ...
 */
  ...
  if(part2remain > 0)
    ...
    printf("mpglib: mpg123: Can't rewind stream by %d bits!\n",-part2remain);
    return 1; /* -> error */
  }
  return 0;
}
 ...
 */
  ...
  if(part2remain > 0 )
    ...
    printf("mpglib: mpg123_ms: Can't rewind stream by %d bits!\n",-part2remain);
    return 1; /* -> error */
  }
  return 0;
}
