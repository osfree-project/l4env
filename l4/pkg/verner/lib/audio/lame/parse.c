...
void lame_usage(lame_global_flags *gfp,char *name)  /* print syntax & exit */
{
  ...
  printf("lame: \n");
  printf("lame: USAGE   :  %s [options] <infile> [outfile]\n",name);
  printf("lame: \n<infile> and/or <outfile> can be \"-\", which means stdin/stdout.\n");
  printf("lame: \n");
  printf("lame: Try \"%s --help\" for more information\n",name);
  exit(1);
}
...
void lame_help(lame_global_flags *gfp,char *name)  /* print syntax & exit */
{
  ...
  printf("lame: \n");
  printf("lame: OPTIONS :\n");
  printf("lame:   Input options:\n");
  printf("lame:     -r              input is raw pcm\n");
  printf("lame:     -x              force byte-swapping of input\n");
  printf("lame:     -s sfreq        sampling frequency of input file(kHz) - default 44.1kHz\n");
  printf("lame:     --mp3input      input file is a MP3 file\n");
  printf("lame: \n");
  printf("lame:   Filter options:\n");
  printf("lame:     -k              keep ALL frequencies (disables all filters)\n");
  printf("lame:   --lowpass freq         frequency(kHz), lowpass filter cutoff above freq\n");
  printf("lame:   --lowpass-width freq   frequency(kHz) - default 15%% of lowpass freq\n");
  printf("lame:   --highpass freq        frequency(kHz), highpass filter cutoff below freq\n");
  printf("lame:   --highpass-width freq  frequency(kHz) - default 15%% of highpass freq\n");
  printf("lame:   --resample sfreq  sampling frequency of output file(kHz)- default=input sfreq\n");
  printf("lame:   --cwlimit freq    compute tonality up to freq (in kHz) default 8.8717\n");
  printf("lame: \n");
  printf("lame:   Operational options:\n");
  printf("lame:     -m mode         (s)tereo, (j)oint, (f)orce or (m)ono  (default j)\n");
  printf("lame:                     force = force ms_stereo on all frames. Faster\n");
  printf("lame:     -a              downmix from stereo to mono file for mono encoding\n");
  printf("lame:     -d              allow channels to have different blocktypes\n");
  printf("lame:     -S              don't print progress report, VBR histograms\n");
  printf("lame:     --athonly       only use the ATH for masking\n");
  printf("lame:     --noath         disable the ATH for masking\n");
  printf("lame:     --noshort       do not use short blocks\n");
  printf("lame:     --voice         experimental voice mode\n");
  printf("lame:     --preset type   type must be phone, voice, fm, tape, hifi, cd or studio\n");
  printf("lame:                     help gives some more infos on these\n");
  printf("lame: \n");
  printf("lame:   CBR (constant bitrate, the default) options:\n");
  printf("lame:     -h              higher quality, but a little slower.  Recommended.\n");
  printf("lame:     -f              fast mode (very low quality)\n");
  printf("lame:     -b bitrate      set the bitrate, default 128kbps\n");
  printf("lame: \n");
  printf("lame:   VBR options:\n");
  printf("lame:     -v              use variable bitrate (VBR)\n");
  printf("lame:     -V n            quality setting for VBR.  default n=%i\n",gfp->VBR_q);
  printf("lame:                     0=high quality,bigger files. 9=smaller files\n");
  printf("lame:     -b bitrate      specify minimum allowed bitrate, default 32kbs\n");
  printf("lame:     -B bitrate      specify maximum allowed bitrate, default 256kbs\n");
  printf("lame:     -t              disable Xing VBR informational tag\n");
  printf("lame:     --nohist        disable VBR histogram display\n");
  printf("lame: \n");
  printf("lame:   MP3 header/stream options:\n");
  printf("lame:     -e emp          de-emphasis n/5/c  (obsolete)\n");
  printf("lame:     -c              mark as copyright\n");
  printf("lame:     -o              mark as non-original\n");
  printf("lame:     -p              error protection.  adds 16bit checksum to every frame\n");
  printf("lame:                     (the checksum is computed correctly)\n");
  printf("lame:     --nores         disable the bit reservoir\n");
  printf("lame: \n");
  printf("lame:   Specifying any of the following options will add an ID3 tag:\n");
  printf("lame:      --tt \"title\"     title of song (max 30 chars)\n");
  printf("lame:      --ta \"artist\"    artist who did the song (max 30 chars)\n");
  printf("lame:      --tl \"album\"     album where it came from (max 30 chars)\n");
  printf("lame:      --ty \"year\"      year in which the song/album was made (max 4 chars)\n");
  printf("lame:      --tc \"comment\"   additional info (max 30 chars)\n");
  printf("lame:                       (or max 28 chars if using the \"track\" option)\n");
  printf("lame:      --tn \"track\"     track number of the song on the CD (1 to 99)\n");
  printf("lame:                       (using this option will add an ID3v1.1 tag)\n");
  printf("lame:      --tg \"genre\"     genre of song (name or number)\n");
  printf("lame: \n");
#ifdef HAVEGTK
  printf("lame:     -g              run graphical analysis on <infile>\n");
#endif
  display_bitrates(1);
  exit(0);
}
...
void lame_presets_info(lame_global_flags *gfp,char *name)  /* print syntax & exit */
{
  lame_print_version(stdout);
  printf("lame: \n");
  printf("lame: Presets are some shortcuts for common settings.\n");
  printf("lame: They can be combined with -v if you want VBR MP3s.\n");
  printf("lame: \n");
  printf("lame:   --preset phone    =>  --resample      16\n");
  printf("lame:                         --highpass       0.260\n");
  printf("lame:                         --highpasswidth  0.040\n");
  printf("lame:                         --lowpass        3.700\n");
  printf("lame:                         --lowpasswidth   0.300\n");
  printf("lame:                         --noshort\n");
  printf("lame:                         -m   m\n");
  printf("lame:                         -b  16\n");
  printf("lame:                   plus  -b   8  \\\n");
  printf("lame:                         -B  56   > in combination with -v\n");
  printf("lame:                         -V   5  /\n");
  printf("lame: \n");
  printf("lame:   --preset voice:   =>  --resample      24\n");
  printf("lame:                         --highpass       0.100\n");
  printf("lame:                         --highpasswidth  0.020\n");
  printf("lame:                         --lowpass       11\n");
  printf("lame:                         --lowpasswidth   2\n");
  printf("lame:                         --noshort\n");
  printf("lame:                         -m   m\n");
  printf("lame:                         -b  32\n");
  printf("lame:                   plus  -b   8  \\\n");
  printf("lame:                         -B  96   > in combination with -v\n");
  printf("lame:                         -V   4  /\n");
  printf("lame: \n");
  printf("lame:   --preset fm:      =>  --resample      32\n");
  printf("lame:                         --highpass       0.030\n");
  printf("lame:                         --highpasswidth  0\n");
  printf("lame:                         --lowpass       11.4\n");
  printf("lame:                         --lowpasswidth   0\n");
  printf("lame:                         -m   j\n");
  printf("lame:                         -b  96\n");
  printf("lame:                   plus  -b  32  \\\n");
  printf("lame:                         -B 192   > in combination with -v\n");
  printf("lame:                         -V   4  /\n");
  printf("lame: \n");
  printf("lame:   --preset tape:    =>  --lowpass       17\n");
  printf("lame:                         --lowpasswidth   2\n");
  printf("lame:                         --highpass       0.015\n");
  printf("lame:                         --highpasswidth  0.015\n");
  printf("lame:                         -m   j\n");
  printf("lame:                         -b 128\n");
  printf("lame:                   plus  -b  32  \\\n");
  printf("lame:                         -B 192   > in combination with -v\n");
  printf("lame:                         -V   4  /\n");
  printf("lame: \n");
  printf("lame:   --preset hifi:    =>  --lowpass       20\n");
  printf("lame:                         --lowpasswidth   3\n");
  printf("lame:                         --highpass       0.015\n");
  printf("lame:                         --highpasswidth  0.015\n");
  printf("lame:                         -h\n");
  printf("lame:                         -m   j\n");
  printf("lame:                         -b 160\n");
  printf("lame:                   plus  -b  32  \\\n");
  printf("lame:                         -B 224   > in combination with -v\n");
  printf("lame:                         -V   3  /\n");
  printf("lame: \n");
  printf("lame:   --preset cd:      =>  -k\n");
  printf("lame:                         -h\n");
  printf("lame:                         -m   s\n");
  printf("lame:                         -b 192\n");
  printf("lame:                   plus  -b  80  \\\n");
  printf("lame:                         -B 256   > in combination with -v\n");
  printf("lame:                         -V   2  /\n");
  printf("lame: \n");
  printf("lame:   --preset studio:  =>  -k\n");
  printf("lame:                         -h\n");
  printf("lame:                         -m   s\n");
  printf("lame:                         -b 256\n");
  printf("lame:                   plus  -b 112  \\\n");
  printf("lame:                         -B 320   > in combination with -v\n");
  printf("lame:                         -V   0  /\n");
  printf("lame: \n");
...
void lame_parse_args(lame_global_flags *gfp,int argc, char **argv)
{
  ...
  while(++i<argc && err == 0) {
	...
	if (strcmp(token, "resample")==0) {
	  ...
	  if (srate  < 1) {
	    printf("lame: Must specify a samplerate with --resample\n");
	    exit(1);
	  }
	}
	...
	/* options for ID3 tag */
		...
		if (argUsed>genre_last) { 
		  argUsed=255; 
		  printf("lame: Unknown genre: %s.  Specifiy genre number \n", nextArg);
		}
	  ...
	  if (gfp->lowpassfreq  < 1) {
	    printf("lame: Must specify lowpass with --lowpass freq, freq >= 0.001 kHz\n");
	    exit(1);
	  }
	}
	  ...
	  if (gfp->lowpasswidth  < 0) {
	    printf("lame: Must specify lowpass width with --lowpass-width freq, freq >= 0 kHz\n");
	    exit(1);
	  }
	}
	  ...
	  if (gfp->highpassfreq  < 1) {
	    printf("lame: Must specify highpass with --highpass freq, freq >= 0.001 kHz\n");
	    exit(1);
	  }
	}
	  ...
	  if (gfp->highpasswidth  < 0) {
	    printf("lame: Must specify highpass width with --highpass-width freq, freq >= 0 kHz\n");
	    exit(1);
	  }
	}
	  ...
	  if (gfp->cwlimit <= 0 ) {
	    printf("lame: Must specify cwlimit in kHz\n");
	    exit(1);
	  }
	  ...
	  else if (strcmp(nextArg,"help")==0)
	  {
	    ...
	    {
	      printf("lame: %s: --preset type, type must be phone, voice, fm, tape, hifi, cd or studio, not %s\n",
		      programName, nextArg);
	      exit(1);
	    }
	} /* --preset */
	...
	case 'm':        argUsed = 1;   gfp->mode_fixed = 1;
	  if (*arg == 's')
	    ...
	    printf("lame: %s: -m mode must be s/d/j/f/m not %s\n",
		    programName, arg);
	    err = 1;
	  }
	  break;
...
#ifdef LIBSNDFILE
	  printf("lame: WARNING: libsndfile may ignore -r and perform fseek's on the input.\n");
	  printf("lame: Compile without libsndfile if this is a problem.\n");
#endif
	...
	case 'X':        argUsed = 1;   gfp->experimentalX = 0;
	  if (*arg == '0')
	    ...
	    printf("lame: %s: -X n must be 0-6, not %s\n",
		    programName, arg);
	    err = 1;
	  }
	  break;
	...
	case 'g': /* turn on gtk analysis */
	  ...
	  gfp->gtkflag = TRUE;
#else
	    printf("lame: LAME not compiled with GTK support, -g not supported.\n",
		    programName, arg);
#endif
	  break;
	...
	case 'e':        argUsed = 1;
	  if (*arg == 'n')                    gfp->emphasis = 0;
	    ...
	    printf("lame: %s: -e emp must be n/5/c not %s\n",
		    programName, arg);
	    err = 1;
	  }
	  break;
	...
	default:    printf("lame: %s: unrec option %c\n",
				programName, c);
	err = 1; break;
	}
	if(argUsed) {
  ...
  if (outPath[0]=='-') {
    ...
    if (id3tag.used) {
      ...
      printf("lame: id3tag ignored: id3 tagging not supported for stdout.\n");
    }
  }
  ...
  if (gfp->input_format == sf_mp3) {
    printf("lame: Error: libmp3lame not compiled with mp3 *decoding* support \n");
    exit(1);
  }
#endif
