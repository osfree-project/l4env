...
Huffmancodebits( BF_PartHolder **pph, int *ix, gr_info *gi )
{
	...
	int remainingBits = stuffingBits % 32;
        ...
        printf("lame: opps - adding stuffing bits = %i.\n",stuffingBits);
        printf("lame: this should not happen...\n");
...
#ifdef DEBUG
    printf("lame: ## %d Huffman bits written (%02d + %02d), part2_length = %d, part2_3_length = %d, %d stuffing ##\n",
