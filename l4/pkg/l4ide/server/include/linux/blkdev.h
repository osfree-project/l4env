...
typedef void (unplug_fn) (request_queue_t *q);
...
#else /* DDE_IDE */
	/*
	 * queue kobject - emulation
	 */
	struct gendisk		*parent;
...
#ifdef DDE_IDE
	l4_threadid_t		irq_thread_id;	// ID of IRQ worker thread (for dataspace sharing)
#endif /* DDE_IDE */
...
#ifdef DDE_IDE
void add_bdev(struct gendisk *, int part);
#endif /* DDE_IDE */
