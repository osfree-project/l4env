...
struct file_operations {
	...
	int (*release) (struct inode *, struct file *);
#else /* DDE_IDE */
	int (*release) (struct block_device *, void *);
#endif /* DDE_IDE */
...
#else /* DDE_IDE */
extern struct block_device *bdget(dev_t, int);
#endif /* DDE_IDE */
...
#else /* DDE_IDE */
extern int blkdev_open(struct block_device *, void *);
#endif /* DDE_IDE */
...
#else /* DDE_IDE */
extern int blkdev_get(struct block_device *);
#endif /* DDE_IDE */
