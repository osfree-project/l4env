...
extern FILE *__stdio_init_file(int fd, int closeonerror, int mode);
#else
FILE* __stdio_init_file(int fd,int closeonerror,int mode) __attribute__((alias("__stdio_init_file_nothreads")));
#endif
