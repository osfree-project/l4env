/**
 *	\file	dice/src/be/sock/SockBEReplyRcvFunction.cpp
 *	\brief	contains the implementation of the class CSockBEReplyRcvFunction
 *
 *	\date	11/29/2002
...
IMPLEMENT_DYNAMIC(CSockBEReplyRcvFunction);

CSockBEReplyRcvFunction::CSockBEReplyRcvFunction()
{
    IMPLEMENT_DYNAMIC_BASE(CSockBEReplyRcvFunction, CBEReplyRcvFunction);
}

CSockBEReplyRcvFunction::CSockBEReplyRcvFunction(CSockBEReplyRcvFunction & src)
 ...
 */
void CSockBEReplyRcvFunction::WriteInvocation(CBEFile * pFile, CBEContext * pContext)
{
 ...
 *  \param pContext the context of the write operation
 */
void CSockBEReplyRcvFunction::WriteVariableDeclaration(CBEFile * pFile, CBEContext * pContext)
{
 ...
 */
bool CSockBEReplyRcvFunction::AddMessageBuffer(CFEInterface * pFEInterface, CBEContext * pContext)
{
    if (!CBEReplyRcvFunction::AddMessageBuffer(pFEInterface, pContext))
        return false;
