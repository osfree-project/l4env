 ...
 */
void CBESocket::WriteSendTo(CBEFile& pFile, CBEFunction* pFunction, bool bUseEnv, const char* sFunc)
{
 ...
 */
void CBESocket::WriteReceiveFrom(CBEFile& pFile, CBEFunction* pFunction, bool bUseEnv)
{
	CBENameFactory *pNF = CBENameFactory::Instance();
	string sCorbaObj = pNF->GetCorbaObjectVariable();
 ...
 *  \param pFunction the function to write for
 */
void CBESocket::WriteExceptionClear(CBEFile& pFile, CBEFunction* pFunction)
{
 ...
 */
void CBESocket::WriteTimeoutOptionCall(CBEFile& pFile, CBEFunction* pFunction, bool bUseEnv)
{
...
void CBESocket::WriteCall(CBEFile& pFile, CBEFunction* pFunction)
{
	...
	// receive response
	WriteTimeoutOptionCall(pFile, pFunction, false);
 ...
 *  \param pFunction the function to write for
 */
void CBESocket::WriteZeroMsgBuffer(CBEFile& pFile, CBEFunction* pFunction)
{
 ...
 */
void CBESocket::WriteInitialization(CBEFile& pFile, CBEFunction *pFunction)
{
 ...
 *  \param pFunction the funtion to write for
 */
void CBESocket::WriteCleanup(CBEFile& pFile, CBEFunction *pFunction)
{
	pFile << "\tclose (";
