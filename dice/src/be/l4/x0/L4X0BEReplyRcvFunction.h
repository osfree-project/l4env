...
#ifndef CL4X0BEREPLYRCVFUNCTION_H
#define CL4X0BEREPLYRCVFUNCTION_H


#include <be/l4/L4BEReplyRcvFunction.h>

/** \class CL4X0BEReplyRcvFunction
 *  \ingroup backend
 *  \brief implements X0 specific ipc code
 **/
class CL4X0BEReplyRcvFunction : public CL4BEReplyRcvFunction
{
DECLARE_DYNAMIC(CL4X0BEReplyRcvFunction);

public:
  CL4X0BEReplyRcvFunction();
  ~CL4X0BEReplyRcvFunction();
