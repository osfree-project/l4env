/**
 *  \file    dice/src/be/l4/x0/L4X0BEMsgBuffer.cpp
 *  \brief   contains the implementation of the class CL4X0BEMsgBuffer
 *
 *  \date    08/03/2006
...
CL4X0BEMsgBuffer::CL4X0BEMsgBuffer()
 : CL4BEMsgBuffer()
{
}

CL4X0BEMsgBuffer::CL4X0BEMsgBuffer(CL4X0BEMsgBuffer & src)
 : CL4BEMsgBuffer(src)
{
}
 ...
 */
CObject* CL4X0BEMsgBuffer::Clone()
{ 
 ...
 */
bool
CL4X0BEMsgBuffer::AddPlatformSpecificMembers(CBEFunction *pFunction,
 ...
 */
int
CL4X0BEMsgBuffer::GetPayloadOffset()
{
 ...
 */
bool
CL4X0BEMsgBuffer::AddGenericStruct(CBEFunction *pFunction,
 ...
 */
bool
CL4X0BEMsgBuffer::WriteRefstringInitFunction(CBEFile *pFile,
 ...
 */
void
CL4X0BEMsgBuffer::WriteRefstringInitParameter(CBEFile *pFile,
    CBEFunction *pFunction,
 ...
 */
void
CL4X0BEMsgBuffer::WriteDopeShortInitialization(CBEFile *pFile,
    int nType,
 ...
 */
void
CL4X0BEMsgBuffer::WriteRcvFlexpageInitialization(CBEFile *pFile,
    CMsgStructType nType)
{
 ...
 */
int
CL4X0BEMsgBuffer::GetMemberPosition(string sName,
    CMsgStructType nType)
{
    CBENameFactory *pNF = CCompiler::GetNameFactory();
