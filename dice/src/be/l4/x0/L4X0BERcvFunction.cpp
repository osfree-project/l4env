 ...
 */
void CL4X0BERcvFunction::WriteVariableDeclaration(CBEFile * pFile,  CBEContext * pContext)
{
 ...
 *  \param pContext the context of the write operation
 */
void CL4X0BERcvFunction::WriteUnmarshalling(CBEFile* pFile,  int nStartOffset,  bool& bUseConstOffset,  CBEContext* pContext)
{
