/**
 *	\file	dice/src/be/l4/v2/L4V2BEO1Marshaller.h
 *	\brief	contains the declaration of the class CL4V2BEO1Marshaller
 *
 *	\date	05/20/2003
...
/** \class CL4V2BEO1Marshaller
 *  \brief implements L4V2 specific marshalling primitives
 */
class CL4V2BEO1Marshaller : public CL4BEO1Marshaller
{
DECLARE_DYNAMIC(CL4V2BEO1Marshaller);
