/**
 *	\file	dice/src/be/l4/v2/L4V2BEO1Marshaller.cpp
 *	\brief	contains the implementation of the class CL4V2BEO1Marshaller
 *
 *	\date	05/20/2003
...
IMPLEMENT_DYNAMIC(CL4V2BEO1Marshaller);

CL4V2BEO1Marshaller::CL4V2BEO1Marshaller()
 : CL4BEO1Marshaller()
{
    IMPLEMENT_DYNAMIC_BASE(CL4V2BEO1Marshaller, CL4BEO1Marshaller);
}
 ...
 */
int CL4V2BEO1Marshaller::Marshal(CBEFile* pFile,  CBETypedDeclarator* pParameter,  int nStartOffset,  bool& bUseConstOffset,  bool bLastParameter,  CBEContext* pContext)
{
    int nSize = CL4BEO1Marshaller::Marshal(pFile, pParameter, nStartOffset, bUseConstOffset, bLastParameter, pContext);
