...
{
    CCompiler::Verbose(PROGRAM_VERBOSE_NORMAL, "CL4V4BEClassFactory: created class CL4V4BEIPC\n");
...
{
    CCompiler::Verbose(PROGRAM_VERBOSE_NORMAL, "CL4V4BEClassFactory: created class CL4V4BESizes\n");
