/**
 *  \file    dice/src/be/l4/fiasco/L4FiascoBEWaitFunction.cpp
 *  \brief   contains the implementation of the class CL4FiascoBEWaitFunction
 *
 *  \date    11/6/2007
...
CL4FiascoBEWaitFunction::CL4FiascoBEWaitFunction(bool bOpenWait)
: CL4BEWaitFunction(bOpenWait)
{ }

/** destroys this object */
CL4FiascoBEWaitFunction::~CL4FiascoBEWaitFunction()
{ }
 ...
 */
void CL4FiascoBEWaitFunction::CreateBackEnd(CFEOperation *pFEOperation, bool bComponentSide)
{
	CL4BEWaitFunction::CreateBackEnd(pFEOperation, bComponentSide);
