/**
 *  \file    dice/src/be/l4/fiasco/L4FiascoBESndFunction.cpp
 *  \brief   contains the implementation of the class CL4FiascoBESndFunction
 *
 *  \date    11/06/2007
...
CL4FiascoBESndFunction::CL4FiascoBESndFunction()
{ }
...
/** \brief creates the send function
 ...
 */
void CL4FiascoBESndFunction::CreateBackEnd(CFEOperation *pFEOperation, bool bComponentSide)
{
	CL4BESndFunction::CreateBackEnd(pFEOperation, bComponentSide);
