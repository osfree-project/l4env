...
#ifndef L4X0aBEREPLYWAITFUNCTION_H
#define L4X0aBEREPLYWAITFUNCTION_H


#include <be/l4/L4BEReplyWaitFunction.h>

/** \class CL4X0aBEReplyWaitFunction
 *  \ingroup backend
 *  \brief implements L4 X0 specific ipc code
 */
class CL4X0aBEReplyWaitFunction : public CL4BEReplyWaitFunction
{
DECLARE_DYNAMIC(CL4X0aBEReplyWaitFunction);

public:
  CL4X0aBEReplyWaitFunction();
  ~CL4X0aBEReplyWaitFunction();
