...
#ifndef CL4X0aBEREPLYRCVFUNCTION_H
#define CL4X0aBEREPLYRCVFUNCTION_H


#include <be/l4/L4BEReplyRcvFunction.h>

/** \class CL4X0aBEReplyRcvFunction
 *  \ingroup backend
 *  \brief implements X0 specific ipc code
 **/
class CL4X0aBEReplyRcvFunction : public CL4BEReplyRcvFunction
{
DECLARE_DYNAMIC(CL4X0aBEReplyRcvFunction);

public:
  CL4X0aBEReplyRcvFunction();
  ~CL4X0aBEReplyRcvFunction();
