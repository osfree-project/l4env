...
public:
    ...
    virtual int Unmarshal(CBEFile * pFile, CBEFunction * pFunction, int nFEType, int nStartOffset, bool& bUseConstOffset, CBEContext * pContext);
    ...
    virtual bool MarshalToPosition(CBETypedDeclarator *pParameter,  int nPosition,  int nPosSize,  int nCurSize,  bool bWrite,  CBEContext * pContext);
