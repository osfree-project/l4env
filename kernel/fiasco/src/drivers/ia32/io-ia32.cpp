...
IMPLEMENT inline
Unsigned8  Io::in8 ( unsigned port )
{
  Unsigned8 tmp;
...
IMPLEMENT inline
Unsigned16 Io::in16( unsigned port )
{
  Unsigned16 tmp;
...
IMPLEMENT inline
Unsigned32 Io::in32( unsigned port )
{
  Unsigned32 tmp;
...
IMPLEMENT inline
void Io::out8 ( Unsigned8  val, unsigned port )
{
  asm volatile ("outb %b0, %w1": : "a"(val), "Nd"(port) );
}

IMPLEMENT inline
void Io::out16( Unsigned16 val, unsigned port )
{
  asm volatile ("outw %w0, %w1": : "a"(val), "Nd"(port) );
}

IMPLEMENT inline
void Io::out32( Unsigned32 val, unsigned port )
{
